...
// Définissez ici l'URL de base de votre API
...
function ImprovedChat() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Utilisation d'une URL relative ou basée sur API_BASE_URL
      ...
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: res.data.response, language: responseLanguage }
      ]);
    } catch (error) {
      setError(
        currentLanguage === "ar"
  ...
  const submitFeedback = async () => {
    ...
    try {
      ...
      alert(currentLanguage === "ar" ? "شكرا على ملاحظاتك!" : "Merci pour votre feedback !");
    } catch (error) {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      setUploadStatus(currentLanguage === "ar" ? "تم رفع المستند بنجاح!" : "Document uploadé avec succès!");
  ...
  return (
    <div className={`chat-container ${currentLanguage === "ar" ? "rtl-container" : ""}`}>
      ...
      <div className="chat-header">
        <h1>
          {currentLanguage === "ar" ? "المساعد القانوني التونسي" : "Assistant Juridique Tunisien"}
        </h1>
      ...
      <div className="messages-container">
        {messages.length === 0 ? (
          <div className={`welcome-message ${currentLanguage === "ar" ? "arabic-text" : ""}`}>
            ...
            <button className="document-button" onClick={() => setShowDocumentUpload(true)}>
          ...
          (searchQuery.trim() === "" ? messages : filteredMessages).map((msg, index) => (
            <div key={index} className={`message ${msg.role}-message ${msg.isDocument ? "document-message" : ""}`}>
      ...
      <form onSubmit={handleSubmit} className="message-form">
        ...
        <div className="button-container">
          ...
          <button type="submit" disabled={loading || !message.trim()} className={currentLanguage === "ar" ? "arabic-text" : ""}>
            {loading ? (currentLanguage === "ar" ? "جاري الإرسال..." : "Envoi...") : currentLanguage === "ar" ? "إرسال" : "Envoyer"}
          </button>
        </div>
      </form>
        ...
        <>
          ...
          <div className="feedback-modal">
            ...
            <div className="feedback-buttons">
              <button onClick={() => setShowFeedback(false)} className={currentLanguage === "ar" ? "arabic-text" : ""}>
                {currentLanguage === "ar" ? "إلغاء" : "Annuler"}
              </button>
              <button onClick={submitFeedback} className={currentLanguage === "ar" ? "arabic-text" : ""} disabled={currentRating === 0}>
        ...
        <>
          ...
          <div className="document-modal">
            ...
            <div className="file-upload-container">
              ...
              {selectedFile && (
                <div className="file-info">
                  <p>
                    {currentLanguage === "ar" ? "حجم الملف:" : "Taille du fichier:"}{" "}
            ...
            <div className="document-buttons">
              <button onClick={() => setShowDocumentUpload(false)} className={currentLanguage === "ar" ? "arabic-text" : ""}>
                {currentLanguage === "ar" ? "إلغاء" : "Annuler"}
              </button>
              <button onClick={handleFileUpload} className={currentLanguage === "ar" ? "arabic-text" : ""} disabled={!selectedFile || uploadProgress > 0}>
